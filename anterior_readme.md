...
- Un participante puede vender un jugador de forma inmediata al **70% del valor de mercado**.
...
- A partir de **una cantidad de días especificada en la creacion del torneo desde el inicio del mismo**, se habilita la compra directa por cláusula.
...
- El nuevo dueño tiene unos minutos en los cuales el jugador se bloquea, para que pueda aumentarle la clausula. Esto evita la recompra inmediata.
...
- **4 horas después** de finalizada la fecha:
  1. Se consultan los puntajes de la API para todos los jugadores.
  ...
  5. Se le otorga dinero a cada participante en función de la posición en que hayan terminado al sumar los puntos de dicha fecha. El dinero otorgado es de 1M de base + 500k por cada 3 posiciones alejadas del top 3.
...
- Integración con API de estadísticas SportsApiPro
