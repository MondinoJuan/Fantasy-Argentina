...
-- 3) Tournament
INSERT INTO tournament (id_tournament, name, id_league, initial_budget, squad_size, status, clause_enable_date) VALUES
...
INSERT INTO participant (id_participant, id_user, id_tournament, bank_budget, reserved_money, total_points) VALUES
...
-- 6) RealPlayer
INSERT INTO realplayer (id_real_player, external_api_id, name, position, id_real_team, market_value, active) VALUES
...
INSERT INTO `transaction`(`id_transaction`, `id_origin_participant`, `id_target_participant`, `id_tournament`, `type`, `amount`, `ref_table`, `ref_id`, `creation_date`, 
...
INSERT INTO negotiation (id_negotiation, id_tournament, id_seller_participant, id_buyer_participant, id_real_player, agreed_amount, status, creation_date, publish_date, 
